...
while ($row = $result->fetch_assoc()) {
    ...
    echo '<td>
            <a href="dosen.php?action=edit&id=' . intval($row['id']) . '" title="Edit">
                <i class="fas fa-edit" style="color: #3498db;"></i>
            </a> | 
            <a href="dosen.php?action=delete&id=' . intval($row['id']) . '" onclick="return confirm(\'Yakin ingin menghapus?\')" title="Delete">
